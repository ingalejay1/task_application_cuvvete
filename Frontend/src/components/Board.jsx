      ...
      <div className="boardCon">
        <div className="backlog boardContent">
          <div className="boardContentHeader">
            <p>Backlog</p>
            <button
              className="collapseAllBtn"
              onClick={() => collapseAllExpandedChecklists("backlog")}
            >
            ...
            {filterTasksByDuration(tasks.backlog).map((task) => (
              <Task
                ...
                toggleChecklistExpansion={() =>
                  toggleChecklistExpansion(task._id)
                }
              />
            ))}
          </div>
        ...
        <div className="toDo boardContent">
          <div className="boardContentHeader">
            ...
            <div className="toDoHeaderBtns">
              ...
              <button
                className="collapseAllBtn"
                onClick={() => collapseAllExpandedChecklists("toDo")}
              >
                <img src={CollapseAllIcon} alt="compress task" />
              </button>
            </div>
        ...
        <div className="inProgress boardContent">
          <div className="boardContentHeader">
            ...
            <button
              className="collapseAllBtn"
              onClick={() => collapseAllExpandedChecklists("inProgress")}
            >
              <img src={CollapseAllIcon} alt="compress task" />
            </button>
          </div>
        ...
        <div className="done boardContent">
          <div className="boardContentHeader">
            ...
            <button
              className="collapseAllBtn"
              onClick={() => collapseAllExpandedChecklists("done")}
            >
              <img src={CollapseAllIcon} alt="compress task" />
            </button>
          </div>
